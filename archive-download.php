                        ...
                        <div class="download-archive-top-content">
                            ...
                            <div class="category-dropdown">
                                <select name="cat" id="category" onchange="document.getElementById('ordering_form').submit();">
                                    <option value=""><?php esc_html_e('Select Category','bytesed');?></option>
                                    <?php
                            ...
                            <div class="order-dropdown">
                                <select name="orderby" id="orderby" onchange="document.getElementById('ordering_form').submit();">
                                    <?php
                                        $orderby_arr = array(
											'newsest' => esc_html__('Newest Items','bytesed'),
											'best_sold' => esc_html__('Best Selling Items','bytesed'),
											'best_ratings' => esc_html__('Best Ratings','bytesed'),
											'high_price' => esc_html__('Highest Price','bytesed'),
											'low_price' => esc_html__('Lowest Price','bytesed'),
                                        );
