...
//				),
		...
		public function load_theme_js() {
			...
			$all_js_files = array(
				...
				// array(
				// 	'handle' => 'bootstrap',
				// 	'src' => BYTESED_JS .'/bootstrap.min.js',
				...
				// array(
				// 	'handle' => 'magnific-popup',
				// 	'src' => BYTESED_JS .'/jquery.magnific-popup.js',
				// 	'deps' => array('jquery'),
				// 	'ver' => $theme_version,
				// 	'in_footer' => true,
				// ),
				// array(
				// 	'handle' => 'bytesed-main-script',
